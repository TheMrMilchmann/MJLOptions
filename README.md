...
1. **Options**<br>
    ...
    All options are uniquely identifiable by a case-sensitive alphanumeric key (`[A-Za-z][A-Za-z0-9]*`). These keys are
    also referred to as "long tokens" throughout this document.<br>
